...
The narration handoff, scene timings, and trailer copy remain in [`demo-video-script.md`](demo-video-script.md). Add the final public video URL here once it is uploaded.
